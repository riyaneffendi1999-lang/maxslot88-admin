  ...
  public: {
    Tables: {
      ...
      admin_activity_log: {
        ...
        Insert: { id?: string; user_id?: string | null; username?: string; email?: string; action: 'login' | 'logout'; created_at?: string };
        Update: Partial<{ user_id: string | null; username: string; email: string; action: 'login' | 'logout' }>;
        Relationships: [];
      };
      bonus_tasks: {
        Row: { id: string; program: string; ticket: string; user_name: string; inject_bonus: number; total_turnover: number; prize: string; status: string; created_at: string; completed_at: string | null; edited_at: string | null; edited_by: string | null; periode: string | null };
        Insert: { id?: string; program: string; ticket: string; user_name: string; inject_bonus: number; total_turnover: number; prize: string; status: string; created_at?: string; completed_at?: string | null; edited_at?: string | null; edited_by?: string | null; periode?: string | null };
        Update: Partial<{ program: string; ticket: string; user_name: string; inject_bonus: number; total_turnover: number; prize: string; status: string; completed_at: string | null; edited_at: string | null; edited_by: string | null; periode: string | null }>;
        Relationships: [];
      };
    };
